...
<body>
	<div class="container">
		...
		<a href="<%=request.getContextPath() %>/home.jsp">
			...
			<button type="button" onclick="location.href='<%=request.getContextPath()%>/cstm/findPwAction.jsp'" class="style-btn">비밀번호 찾기</button>
			<button type="submit" onclick="location.href='<%=request.getContextPath()%>/cstm/findId.jsp'" class="style-btn">아이디 찾기</button>
